...
class RuleSetGenerator
{
    ...
    {
        $literals = array(Literal::createNegativeFromPackage($package));
        ...
        foreach ($providers as $provider) {
            ...
            $literals[] = Literal::createPositiveFromPackage($provider);
        }
    ...
    {
        return new Rule($this->pool, array(Literal::createNegativeFromPackage($package)), $reason, $job['packageName'], $job);
    }
    ...
    protected function createConflictRule(PackageInterface $issuer, PackageInterface $provider, $reason, $reasonData = null)
    {
        ...
        return new Rule($this->pool, array(Literal::createNegativeFromPackage($issuer), Literal::createNegativeFromPackage($provider)), $reason, $reasonData);
    }
